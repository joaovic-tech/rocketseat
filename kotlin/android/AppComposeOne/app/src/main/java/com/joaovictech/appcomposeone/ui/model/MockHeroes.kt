...
fun createHeroList(): List<Hero> {
    val heroNames = stringArrayResource(R.array.hero_names)
    val heroDescriptions = stringArrayResource(R.array.hero_descriptions)
    ...
    val heroes: List<Hero> = heroNames.zip(heroDescriptions).zip(heroImages) { (name, description), imageRes ->
